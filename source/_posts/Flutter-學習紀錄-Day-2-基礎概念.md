...
比較表
| 框架/工具                     | 語言              | Hot Reload 支援 | 發展時間  | Component 支援          | 文件品質                | 社群成熟度    | 效能                     | App 大小 | 特色與備註                                          |
|-----------------------------|------------------|----------------|-----------|------------------------|------------------------|--------------|------------------------|----------|---------------------------------------------------|
| **Flutter**                 | Dart             | 支援           | 2017年    | 由 Google 開發，預設豐富  | 詳細易讀                | 發展中       | 直接轉成 native code     | 較小     | 高效能，豐富的 widget 庫和 Hot Reload 功能         |
| **React Native**            | JavaScript       | 支援           | 2015年    | 需要第三方支援          | 第三方 Library 文件品質不一 | 成熟         | 需透過 Bridge 與平台溝通   | 較大     | 使用 JavaScript 和 React 開發，廣大的社群與資源    |
| **.NET MAUI**               | C#               | 支援           | 2021年    | 由 Microsoft 支持，與 .NET 生態系統整合 | 詳細易讀                | 發展中       | 直接訪問原生 API          | 中等     | 繼承自 Xamarin，與 Visual Studio 緊密整合         |
| **Ionic**                   | JavaScript (Angular, React, Vue) | 支援       | 2013年    | 需要第三方支援          | 第三方 Library 文件品質不一 | 成熟         | 基於 WebView             | 中等     | 使用 web 技術構建應用，依賴於 Cordova 和 Capacitor |
| **Apache Cordova (PhoneGap)** | HTML, CSS, JavaScript | 支援       | 2009年    | 需要第三方支援          | 第三方 Library 文件品質不一 | 成熟         | 基於 WebView             | 中等     | 使用 web 技術構建應用，廣泛的平台支持              |
| **Kotlin Multiplatform Mobile (KMM)** | Kotlin            | 不支援       | 2019年    | 需自行開發              | 詳細易讀                | 發展中       | 直接訪問原生 API          | 中等     | 共享邏輯層，UI 層使用平台原生方式實現              |
| **Unity**                   | C#               | 支援           | 2005年    | 豐富，針對遊戲開發       | 詳細易讀                | 成熟         | 高效能 2D 和 3D 渲染       | 較大     | 遊戲開發為主，但可構建各種應用，支持多平台         |
| **NativeScript**            | JavaScript, TypeScript | 支援       | 2014年    | 需要第三方支援          | 詳細易讀                | 發展中       | 直接訪問原生 API          | 中等     | 使用 Angular 或 Vue.js 構建應用，支援 iOS 和 Android |
